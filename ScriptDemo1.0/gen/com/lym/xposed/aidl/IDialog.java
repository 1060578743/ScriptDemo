 ...
 * Original file: C:\\Users\\980008027\\workspace\\ScriptDemo\\src\\com\\lym\\xposed\\aidl\\IDialog.aidl
 */
package com.lym.xposed.aidl;
public interface IDialog extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.lym.xposed.aidl.IDialog
{
private static final java.lang.String DESCRIPTOR = "com.lym.xposed.aidl.IDialog";
...
/**
 * Cast an IBinder object into an com.lym.xposed.aidl.IDialog interface,
 * generating a proxy if needed.
 */
public static com.lym.xposed.aidl.IDialog asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.lym.xposed.aidl.IDialog))) {
return ((com.lym.xposed.aidl.IDialog)iin);
}
return new com.lym.xposed.aidl.IDialog.Stub.Proxy(obj);
}
...
private static class Proxy implements com.lym.xposed.aidl.IDialog
{
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_dismiss, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_dismiss = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
