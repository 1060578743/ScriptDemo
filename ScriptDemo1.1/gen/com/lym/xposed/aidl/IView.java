 ...
 * Original file: C:\\Users\\980008027\\workspace\\tiebaSend\\src\\com\\lym\\xposed\\aidl\\IView.aidl
 */
...
int _arg1;
_arg1 = data.readInt();
com.lym.xposed.aidl.IView _result = this.clssName(_arg0, _arg1);
reply.writeNoException();
reply.writeStrongBinder((((_result!=null))?(_result.asBinder()):(null)));
return true;
}
...
int _arg1;
_arg1 = data.readInt();
com.lym.xposed.aidl.IView _result = this.text(_arg0, _arg1);
reply.writeNoException();
reply.writeStrongBinder((((_result!=null))?(_result.asBinder()):(null)));
return true;
}
...
int _arg1;
_arg1 = data.readInt();
com.lym.xposed.aidl.IView _result = this.hint(_arg0, _arg1);
reply.writeNoException();
reply.writeStrongBinder((((_result!=null))?(_result.asBinder()):(null)));
return true;
}
...
int _arg1;
_arg1 = data.readInt();
com.lym.xposed.aidl.IView _result = this.desc(_arg0, _arg1);
reply.writeNoException();
reply.writeStrongBinder((((_result!=null))?(_result.asBinder()):(null)));
return true;
}
...
@Override public com.lym.xposed.aidl.IView clssName(java.lang.String clz, int index) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.lym.xposed.aidl.IView _result;
...
@Override public com.lym.xposed.aidl.IView text(java.lang.String text, int index) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.lym.xposed.aidl.IView _result;
...
@Override public com.lym.xposed.aidl.IView hint(java.lang.String text, int index) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.lym.xposed.aidl.IView _result;
...
@Override public com.lym.xposed.aidl.IView desc(java.lang.String text, int index) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.lym.xposed.aidl.IView _result;
...
static final int TRANSACTION_clssName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_text = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_hint = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_desc = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_childCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_x = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_y = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_w = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_h = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_click = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_longClick = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_doubleClick = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_setText = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_scroll = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_getText = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_dump = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_showen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_exist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
}
//子控件
...
public com.lym.xposed.aidl.IView clssName(java.lang.String clz, int index) throws android.os.RemoteException;
//根据文本查找控件

public com.lym.xposed.aidl.IView text(java.lang.String text, int index) throws android.os.RemoteException;
//根据默认值查找控件

public com.lym.xposed.aidl.IView hint(java.lang.String text, int index) throws android.os.RemoteException;
//根据控件说明查找控件

public com.lym.xposed.aidl.IView desc(java.lang.String text, int index) throws android.os.RemoteException;
//子控件数量
