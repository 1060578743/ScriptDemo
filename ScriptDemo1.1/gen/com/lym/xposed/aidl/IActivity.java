 ...
 * Original file: C:\\Users\\980008027\\workspace\\tiebaSend\\src\\com\\lym\\xposed\\aidl\\IActivity.aidl
 */
...
int _arg1;
_arg1 = data.readInt();
this.click(_arg0, _arg1);
reply.writeNoException();
return true;
}
case TRANSACTION_sendKeycode:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.sendKeycode(_arg0);
reply.writeNoException();
return true;
}
}
...
@Override public void click(int x, int y) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void sendKeycode(int keycode) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_sendKeycode, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_click = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_sendKeycode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
}
...
public void click(int x, int y) throws android.os.RemoteException;
public void sendKeycode(int keycode) throws android.os.RemoteException;
}
